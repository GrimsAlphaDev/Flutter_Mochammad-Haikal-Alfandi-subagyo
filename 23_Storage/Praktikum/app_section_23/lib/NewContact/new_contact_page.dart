...
import 'package:app_section_23/NewContact/create_contact_page.dart';
import 'package:app_section_23/NewContact/edit_contact_page.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

import 'contacts_with_provider.dart';
...
class _NewContactPageState extends State<NewContactPage> {
  ...
  ContactWithProvider contact = ContactWithProvider();
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<ContactWithProvider>(context, listen: false);
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: const [
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Consumer<ContactWithProvider>(
                    builder: (context, providerContact, _) {
                  return ListView.builder(
                    itemCount: providerContact.contacts.length,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      return ListTile(
                        leading: CircleAvatar(
                          child:
                              Text(providerContact.contacts[index]['name'][0]),
                          // child: Text(contact.contacts[index]['name'][0]),
                        ),
                        title: Text(
                          // contact.contacts[index]['name'],
                          providerContact.contacts[index]['name'],
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                        subtitle: Text(
                          // contact.contacts[index]['nomor']
                          providerContact.contacts[index]['nomor'],
                        ),
                        trailing: Row(
