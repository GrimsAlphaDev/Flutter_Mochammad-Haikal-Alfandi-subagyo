...
import 'package:app_section_28_ui_test/model/advance_contact_model.dart';
import 'package:file_picker/file_picker.dart';
import 'package:flutter/material.dart';
import 'package:flutter_colorpicker/flutter_colorpicker.dart';
import 'package:intl/intl.dart';

class AdvanceForm2Screen extends StatefulWidget {
  static const String routeName = '/advance-form-2';

  const AdvanceForm2Screen({super.key});

  @override
  State<AdvanceForm2Screen> createState() => _AdvanceForm2ScreenState();
}

class _AdvanceForm2ScreenState extends State<AdvanceForm2Screen> {
                      ...
                      child: TextFormField(
                        ...
                        onTap: () async {
                          ...
                          if (pickedFile != null) {
                            ...
                            debugPrint("File is not selected");
                          }
                        },
                        validator: (value) {
                          if (value == null || value.isEmpty) {
